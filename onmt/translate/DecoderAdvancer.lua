...
--]]
function DecoderAdvancer:__init(decoder, batch, context, max_sent_length, max_num_unks, decStates, dicts, word_pen, length_norm, coverage_norm, eos_norm)
...
function DecoderAdvancer:initBeam()
  ...
  local state = { self.decStates, nil, nil, self.context, nil, features, sourceSizes, 1 , attnProba }
  local params = {}
...
function DecoderAdvancer:update(beam)
  ...
  local decStates, decOut, decCov, context, _, features, sourceSizes, t, cumAttnProba
    = table.unpack(state, 1, 9)
  --~ print(features)
  ...
  local nextState = {decStates, decOut, decCov, context, softmaxOut, nil, sourceSizes, t, cumAttnProba}
